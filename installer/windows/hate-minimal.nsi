; Hate Programming Language - NSIS Installer Script (Minimal)
; Build with: makensis hate-minimal.nsi
;
...
Section "Install"
    ...
    ; Add to PATH (manual registry edit)
...
Section "Uninstall"
    ...
    ; Note: We don't remove from PATH as it could break things
    ; User should manually clean PATH if needed
SectionEnd
